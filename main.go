...
func init() {
	...
	token := flag.String("t", "Xq9VaPERNppsLCvF", "Set AccessToken of WSClient.")
	// 直接写死 URL 时，请更改下面第二个参数
	url := flag.String("u", "ws://124.156.193.131:6700", "Set Url of WSClient.")
	// 默认昵称
	...
	// 通过代码写死的方式添加主人账号
	sus = append(sus, 3061196825, 1770775226)
